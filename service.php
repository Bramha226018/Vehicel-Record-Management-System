...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // Prepare and bind
    $stmt = $conn->prepare("INSERT INTO service (email, service) VALUES (?, ?)");
...
<head>
    ...
    <title>Service Information - VRMS</title>
    <style>
        body {
...
<div class="container">
    ...
    <form action="service.php" method="POST">
        ...
        <button type="submit" class="btn-submit">Submit Service Info</button><br><br>
