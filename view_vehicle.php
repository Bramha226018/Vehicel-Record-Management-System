...
// Prepare the SQL query to fetch vehicle information
$sql = "SELECT number_plate, vehicle_model FROM vehicle_info WHERE email = '$email'";
...
<div class="container">
    ...
    <table>
        ...
        <?php else: ?>
            <tr>
                <td colspan="2">No vehicle information found for this user.</td>
            </tr>
        <?php endif; ?>
        </tbody>
    </table>
